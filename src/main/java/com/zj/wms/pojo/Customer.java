...
public class Customer {
    ...
    private String region_id;      //区域组id
    private String country;         //国家
    private String city;            //城市
    private String region;          //地区
    private String street_address;  //街道地址
    private String post_code;       //邮编
    private String region_id2;      //区域组id
    private String street_address2;  //街道地址
    private String post_code2;       //邮编
    private String official_website;    //官网
    private String duty_paragraph;      //税号
    private String bank;            //开户银行
    private String bank_account;    //开户银行账号
    private String remark;      //备注
    private String kukla;       //客户大类
    private String kuklat;      //客户大类描述
    private String brsch;       //客户小类
    private String brscht;      //客户小类描述
